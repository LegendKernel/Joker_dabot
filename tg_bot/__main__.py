...
from tg_bot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, YANDEX_KEY, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help and join @JokerHarleyNews.
